    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers):
            ...
            if self.normalization == 'batchnorm':
                ...
                out, caches[i] = affine_norm_relu_forward(out, W, b, gamma, beta, self.bn_params[i-1], 'batchnorm')
            elif self.normalization == 'layernorm':
                gamma, beta = self.params[f'gamma{i}'], self.params[f'beta{i}']
                out, caches[i] = affine_norm_relu_forward(out, W, b, gamma, beta, self.bn_params[i-1], 'layernorm')
            else:
        ...
        for i in range(self.num_layers - 1, 0, -1):
            ...
            # ReLU - Norm - Affine backward
            if self.normalization:
                dout, dW, db, dgamma, dbeta = affine_norm_relu_backward(dout, caches[i], self.normalization)
